...
# Documentation
Full documentation is coming, in a meanwhile check out the [example](https://nbviewer.jupyter.org/github/zubara/mneflow/blob/master/mneflow_example.ipynb) notebook
