...
## Data import and the basic MNEflow pipeline

[mneflow_example_tf2.ipynb](https://github.com/zubara/mneflow/blob/master/examples/mneflow_example_tf2.ipynb)

## Regression

[regression_example.ipynb](https://github.com/zubara/mneflow/blob/master/examples/regression_example.ipynb)

## Building a custom network

[own_graph_example.ipynb](https://github.com/zubara/mneflow/blob/master/examples/own_graph_example.ipynb)

## Saving and restoring models

[mneflow_save_restore.ipynb](https://github.com/zubara/mneflow/blob/master/examples/mneflow_save_restore.ipynb)
